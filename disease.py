disease_dic = {
    ...
    'Apple___Cedar_apple_rust': """ Crop: Apple    \nDisease: Cedar Apple Rust
         \nCause of disease:
    ...
    'Blueberry___healthy': """ Crop: Blueberry    \nDisease: No disease
    ...
    'Cherry_(including_sour)___Powdery_mildew': """ Crop: Cherry    \nDisease: Powdery Mildew
         \nCause of disease:
    ...
    'Cherry_(including_sour)___healthy': """ Crop: Cherry    \nDisease: No disease

        "" Don't worry. Your crop is healthy. Keep it up !!!""",


    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ Crop: Corn    \nDisease: Grey Leaf Spot
         \nCause of disease:
    ...
    'Corn_(maize)___Common_rust_': """ Crop: Corn(maize)    \nDisease: Common Rus
         \nCause of disease:
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """ Crop: Corn(maize)    \nDisease: Northern Leaf Blight
        "
         \nCause of disease:
    ...
    'Corn_(maize)___healthy': """ Crop: Corn(maize)    \nDisease: No disease

        "" Don't worry. Your crop is healthy. Keep it up !!!""",


    'Grape___Esca_(Black_Measles)': """ Crop: Grape    \nDisease: Black Measles
         \nCause of disease:
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """ Crop: Grape    \nDisease: Leaf Blight
         \nCause of disease:
    ...
    'Orange___Haunglongbing_(Citrus_greening)': """ Crop: Orange    \nDisease: Citrus Greening
         \nCause of disease:
    ...
    'Peach___Bacterial_spot': """ Crop: Peach    \nDisease: Bacterial Spot
         \nCause of disease:
    ...
    'Pepper,_bell___Bacterial_spot': """ Crop: Pepper    \nDisease: Bacterial Spot
         \nCause of disease:
    ...
    'Peach___healthy': """ Crop: Peach    \nDisease: No disease

        "" Don't worry. Your crop is healthy. Keep it up !!!""",

    'Pepper,_bell___healthy': """ Crop: Pepper    \nDisease: No disease

        "" Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato___healthy': """ Crop: Potato    \nDisease: No disease

        "" Don't worry. Your crop is healthy. Keep it up !!!""",

    'Raspberry___healthy': """ Crop: Raspberry    \nDisease: No disease

        "" Don't worry. Your crop is healthy. Keep it up !!!""",


    'Soybean___healthy': """ Crop: Soyabean    \nDisease: No disease

        "" Don't worry. Your crop is healthy. Keep it up !!!""",

    'Strawberry___healthy': """ Crop: Strawberry    \nDisease: No disease
    ...
    'Potato___Early_blight': """ Crop: Potato    \nDisease: Early Blight
         \nCause of disease:
    ...
    'Potato___Late_blight': """ Crop: Potato    \nDisease: Late Blight
    ...
    'Squash___Powdery_mildew': """ Crop: Squash    \nDisease: Powdery mildew
         \nCause of disease:
    ...
    'Strawberry___Leaf_scorch': """ Crop: Strawberry    \nDisease: Leaf Scorch
         \nCause of disease:
    ...
    'Tomato___Bacterial_spot': """ Crop: Tomato    \nDisease: Bacterial Spot
         \nCause of disease:
    ...
    'Tomato___Early_blight': """ Crop: Tomato    \nDisease: Early Blight
         \nCause of disease:
    ...
    'Tomato___Late_blight': """ Crop: Tomato    \nDisease: Late Blight
    ...
    'Tomato___Leaf_Mold': """ Crop: Tomato    \nDisease: Leaf Mold
         \nCause of disease:
    ...
    'Tomato___Septoria_leaf_spot': """ Crop: Tomato    \nDisease: Leaf Spot
         \nCause of disease:
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': """ Crop: Tomato    \nDisease: Two-spotted spider mite
         \nCause of disease:
    ...
    'Tomato___Target_Spo': """ Crop: Tomato    \nDisease: Target Spot
         \nCause of disease:
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': """ Crop: Tomato    \nDisease: Yellow Leaf Curl Virus
         \nCause of disease:
    ...
    'Tomato___Tomato_mosaic_virus': """ Crop: Tomato    \nDisease: Mosaic Virus
         \nCause of disease:
